           ...
           <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
              	<div class="col-md-6">
              		@if($user->image)
              		<img src="{{url($user->image)}}" width="100%" height="400px" class="rounded mx-auto d-block ">
              		@else
                 ...
                 <div id="edit_content" style="display: none">
                 	<form id="edit_info" method="post" action="{{route('customer_profile')}}" enctype="multipart/form-data">
                 		@csrf
                  <div class="row" >
              	<div class="col-md-6 col-md-offset-4">
              		@if($user->image)
              		<img src="{{url($user->image)}}" width="100%" height="400px" class="rounded mx-auto d-block " id="image">
              		@else
                   ...
                   <div class="col-md-6 col-md-offset-3">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" class="form-control" name="name" value="{{$user->name}}" required="true" placeholder="enter your name">
                        </div>
                      </div>
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="email" class="form-control" name="email" value="{{$user->email}}" required="true" placeholder="Enter email">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" class="form-control" name="phone_no" value="{{$user->phone_no}}" required="true" placeholder="Enter Phone No">
                        </div>
                      </div>
                       <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" class="form-control" name="address" value="{{$user->address}}" required="true" placeholder="Enter Address">
                        </div>
                      </div>
