...
<html lang="en">
  <head>
    ...
    <title>Cold Storage|Provider Home </title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-desktop"></i> Post <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('provider/post_list')}}">List</a></li>
                      <li><a href="{{url('provider/give_post')}}">Give Post</a></li>
                  ...
                  <li><a><i class="fa fa-check-square"></i> Booking <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('provider/booking_list')}}">List</a></li>
                      {{--<li><a href="#">Accepted</a></li>
                      <li><a href="#">Pending</a></li>
                      <li><a href="#">Rejected</a></li>
                  ...
                  <li><a><i class="fa fa-cogs"></i> Setting <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                       <li><a href="{{url('provider/profile')}}">Profile</a></li>
                      {{--<li><a href="#">Update Profile</a></li>--}}
                      <li><a href="{{url('provider/change_password')}}">Change Password</a></li>
                    </ul>
                  </li>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Post List" href="#">
