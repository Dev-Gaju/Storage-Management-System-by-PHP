...
<html lang="en">
  <head>
    ...
    <title>Cold Storage|Admin Home </title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-binoculars"></i> Local Admin <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('admin/local_admin_list')}}">List</a></li>
                      <li><a href="{{url('admin/new_local_admin')}}">Create</a></li>
                    </ul>
                  </li>
                   <li><a><i class="fa fa-user"></i> Customer <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('admin/customer_list')}}">List</a></li>
                      <li><a href="{{url('admin/add_new_customer')}}">Create</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Post <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('admin/post_list')}}">List</a></li>
                  ...
                  <li><a><i class="fa fa-check-square"></i> Booking <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('admin/booking_list')}}">List</a></li>
                      {{--<li><a href="#">Accepted</a></li>
                      <li><a href="#">Pending</a></li>
                      <li><a href="#">Rejected</a></li>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Local Admin" href="#">
                <span class="fa fa-binoculars" aria-hidden="true"></span>
              </a>
              <a data-toggle="tooltip" data-placement="top" title="Customer" href="#">
