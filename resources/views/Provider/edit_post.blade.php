  ...
  <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  @endif
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('update_post')}}" enctype='multipart/form-data'>
                     @csrf
                     <input type="hidden" name="post_id" value="{{$data->id}}">
                      ...
                      <div class="form-group" style="display: none">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea name="details" class="form-control" id="editor">{!!$data->details!!}</textarea>
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text"  name="address" required="required" class="form-control col-md-12 col-xs-12" value="{{$data->address}}" >
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text"  name="latitude" required="required" class="form-control col-md-12 col-xs-12" value="{{$data->latitude}}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text"  name="longitude" required="required" class="form-control col-md-12 col-xs-12" value="{{$data->longitude}}" >
                        </div>
                      </div>
                      ...
                      <div class="form-group" style="display: none">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea name="condition" class="form-control" id="editor2"  >{!!$data->condition!!}</textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12">
                          <input type="number"  name="room" required="required" class="form-control col-md-12 col-xs-12" value="{{$data->room}}">
                        </div>
                         <label class="control-label col-md-2 col-sm-6 col-xs-12" >Room Size<span class="required">*</span>
                        </label>
                        <div class="col-md-2 col-sm-6 col-xs-12">
                          <input type="text"  name="room_size" required="required" class="form-control col-md-12 col-xs-12" placeholder="1000 square fit" value="{{$data->room_size}}">
                        </div>
                          <label class="control-label col-md-1 col-sm-6 col-xs-12" >Rent<span class="required" >*</span>
                        </label>
                        <div class="col-md-2 col-sm-6 col-xs-12">
                          <input type="number"  name="rent" required="required" class="form-control col-md-12 col-xs-12" value="{{$data->rent}}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin-left: 56px;">
                        	<p>Please keep blank if no need to update images..</p>
					@for($i=0;$i<4;$i++)
